...
@Getter
public enum MainCharacter implements EnumInterface {
    ...
    ROBOT("mainCharacter_robot", "mainCharacter_robot_details", AssetLoader.maincharacterTextureRegion[16]),
    UNICORN("mainCharacter_unicorn", "mainCharacter_unicorn_details", AssetLoader.maincharacterTextureRegion[17]),
    ...
    FIREFIGHTER("mainCharacter_firefighter", "mainCharacter_firefighter_details", AssetLoader.maincharacterTextureRegion[26]),
    POLICE("mainCharacter_police", "mainCharacter_police_details", AssetLoader.maincharacterTextureRegion[27]),
    ...
    SUPPORT_FIREFIGHTER("supportingCharacter_firefighter", "supportingCharacter_firefighter_details", AssetLoader.supportCharacterTextureRegion[12]),
    SUPPORT_POLICE("supportingCharacter_police", "supportingCharacter_police_details", AssetLoader.supportCharacterTextureRegion[13]),
    ...
    SUPPORT_ROBOT("supportingCharacter_robot", "supportingCharacter_robot_details", AssetLoader.supportCharacterTextureRegion[23]),
    ...
    SUPPORT_UNICORN("supportingCharacter_unicorn", "supportingCharacter_unicorn_details", AssetLoader.supportCharacterTextureRegion[27]),
    ...
    MainCharacter(final String name, final String details) {
        this(name, details, null);
    }

    MainCharacter(final String name, final String details, final TextureRegion image) {
        this.name = name;
    ...
    public static EnumInterface getRandom() {
        return MainCharacter.values()[(int)(MainCharacter.values().length * Math.random())];
    }
    ...
    public EnumInterface getNext(int add) {
        int index = 0;
        for (MainCharacter character : values()) {
    ...
    public static void refreshAll() {
        for (int i = 0; i < values().length; i++) {
            MainCharacter mainCharacter = values()[i];
            if (i >= AssetLoader.maincharacterTextureRegion.length) {
                mainCharacter.image = AssetLoader.supportCharacterTextureRegion[i-AssetLoader.maincharacterTextureRegion.length];
            } else {
                mainCharacter.image = AssetLoader.maincharacterTextureRegion[i];
            }
        }
    }
}
